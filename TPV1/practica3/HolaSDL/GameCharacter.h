...
protected:
	...
	GameCharacter(Point2D const iniPos, SDLApplication* appPtr, Point2D const framePos, Point2D const size, PlayState* const _playState);
	GameCharacter(ifstream& loadFile, SDLApplication* appPtr, PlayState* const _playState);
};
