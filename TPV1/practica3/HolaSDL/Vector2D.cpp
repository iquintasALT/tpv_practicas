...
ostream& operator<<(ostream& out, Vector2D& const auxVec){
	out << auxVec.xCoor << " " << auxVec.yCoor;
	return out;
}

//lectura de vectores
istream& operator>>(istream& in, Vector2D& auxVec) {
	in >> auxVec.xCoor >> auxVec.yCoor;
	return in;
}
