...
InfoBar::InfoBar(Game* gameP, int* const liveCounter, int* const powerUpActive, int const points, Point2D pos, Point2D size) 
	: GameObject(pos, size.getYCoor(), size.getXCoor(), gameP){
